...
const SnippetsCard: React.FC<SnippetsCardProps> = ({
  ...
  return (
    <div
      className=" relative w-[350px] h-[180px] p-4 hover:scale-102 flex flex-col rounded-lg bg-gradient-to-br from-[#f3f4f6] via-[#d1d5db] to-[#f3f4f6]
    dark:bg-gradient-to-br dark:from-[#D8E1FF]  dark:to-[#F4F6FA] dark:hover:shadow-blue-950
     dark:hover:bg-blue-300 duration-300 hover:bg-[#d1d1d2] hover:shadow-xl border"
    >
      {href ? (
