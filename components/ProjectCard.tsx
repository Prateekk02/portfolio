...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div className="relative bg-[#f3f4f6] dark:bg-blue-200 w-full sm:w-[90%] md:w-[300px] lg:w-[360px] min-h-[300px] p-4 rounded-lg shadow-md hover:shadow-xl dark:hover:shadow-blue-950 dark:hover:bg-blue-300 duration-300 hover:bg-[#d1d1d2] border hover:scale-102 ">
  ...
  <Link key={`title-${title}`} href={githubLink} target="_blank" rel="noopener noreferrer">
    ...
    <Link target="_blank" href={href}  >
      ...
      <div className="text-justify text-md text-neutral-600  p-2">
        {content}
      </div>
